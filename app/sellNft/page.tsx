...
import { SellPageSkeleton } from './sell-page-skeleton';
  ...
  return (
    <AnimatePresence>
      <motion.div 
        ...
        className="min-h-screen bg-gradient-to-br from-gray-100 to-orange-50 p-8"
      >
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div 
            variants={fadeInUp}
            className="relative h-80 bg-gradient-to-r from-orange-400 to-orange-600 rounded-lg mb-8 overflow-hidden shadow-lg"
          >
            <img 
              src="/Designer.jpeg" 
              alt="Selected NFT" 
